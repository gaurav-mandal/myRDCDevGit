  ...
  preShow:function(WM_ENQ_STOCK)
    {
      ...
      printLog("WM_ENQ_STOCK CASE entries ="+WM_ENQ_STOCK.length);      
...
//                  record.ImageBitmap = WM_ENQ_STOCK[i].BITMAP;                         
                    if (WM_ENQ_STOCK[i].ZEINR !== "" &&
                        ...
                        WM_ENQ_STOCK[i].ZEINR !== undefined )
                      {
                         ...
                         printLog("case enquiry drawing = none");
...
//                        record.LabelColour.opacity=30;                
                    ...
                    printLog("append case record"+i);                       
                    data.push(record);                                    
                    
                }
        } 
            printLog("load screen frmCaseEnquiry");
            ...
            this.view.LabelLENUM.text = lenum.toString();       
...
//          goto the stock detail screen  
            glbStockEnqForm = "frmCaseEnquiry";
            dismissLoadingScreen();
